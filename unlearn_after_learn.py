...
class Unlearn_after_Learn(Experiment):
    ...
    def __init__(self, args):
        ...
        self.data_ldr_path='log_test_class/amnesiac_ul_class/alexnet/cifar10/FedUL_dataloader_s3_10_32_0.01_1_2024_1_11.pkl'

        self.pretrained_model_path='log_test_class/amnesiac_ul_class/alexnet/cifar10/Dp_False_0.1_iid_1_num_sign_0_w_type_gamma_loss_sign_B_0_alpha_0.2_num_back_0_type_True_T_0_epoch_200_E_2_u_10_1.0_30.8796_0.8726.pkl'
    ...
    def class_pruning(self,sparsity,unlearn_class):
        ...
        if args.dataset == 'cifar10':
            ...
            in_channels=1
        self.construct_pretrained_model(self.pretrained_model_path,args.model_name,in_channels)
