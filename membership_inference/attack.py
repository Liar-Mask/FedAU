...
def create_attack(dataset, dataPath, modelPath,model_pkl_path, trainTargetModel, trainShadowModel, need_augm, need_topk, param_init, verbose):
    ...
    if (trainTargetModel):
        ...
        #                                 )
        # sub_test_set = DatasetSplit(test_set, np.arange(0, len()/4))
