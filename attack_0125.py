...
def get_cmd_arguments():
    ...
    parser.add_argument('--data_ldr_path', default='/CIS32/zgx/Unlearning/FedUnlearning/log_test_class/ul_class/alexnet/cifar10/FedUL_dataloader_s101_10_32_0.01_1_2024_1_24.pkl') 
    parser.add_argument('--model_pkl_path', default='/CIS32/zgx/Unlearning/FedUnlearning/log_test_class/ul_class/alexnet/cifar10/FedUL_model_s101_10_32_0.01_1_2024_1_24.pkl')
...
def create_attack(dataset, dataPath, modelPath, trainTargetModel, trainShadowModel, need_augm, need_topk, param_init, verbose):
    ...
    modelDir='/CIS32/zgx/Unlearning/FedUnlearning/membership_inference/models'
    ...
    if (trainTargetModel):
        ...
        targetX = t_trainX[70:-1] + t_testX
        targetY = t_trainY[70:-1] + t_testY
    ...
    """测试"""
    model_paths=[
        '/CIS32/zgx/Unlearning/FedUnlearning/log_test_class/ul_class/alexnet/cifar10/FedUL_model_s101_10_32_0.01_1_2024_1_24.pkl',
        '/CIS32/zgx/Unlearning/FedUnlearning/log_test_class/retrain_class/alexnet/cifar10/FedUL_model_s101_10_32_0.01_1_2024_1_24.pkl'
        ]
    data_ldr_paths=[
        '/CIS32/zgx/Unlearning/FedUnlearning/log_test_class/ul_class/alexnet/cifar10/FedUL_dataloader_s101_10_32_0.01_1_2024_1_24.pkl',
        '/CIS32/zgx/Unlearning/FedUnlearning/log_test_class/retrain_class/alexnet/cifar10/FedUL_dataloader_s101_10_32_0.01_1_2024_1_24.pkl'

    ]

    # for model_path, data_ldr_path in zip(model_paths,data_ldr_paths):
    pkl_state_dict=torch.load(args.model_pkl_path)
    target_model.load_state_dict(pkl_state_dict['model_state_dict'])

    with open(args.data_ldr_path,'rb') as f:
        ...
        """
    train_ldr=dataloader_save['train_ldr']  # member
    val_ldr=dataloader_save['val_ldr']      # non-member
    ul_ldr=dataloader_save['ul_ldr']        # member-->non-member Y=[1]  pred=[0]
    # ds = torchvision.datasets.CIFAR10(root=datasetDir, train=True, download=True)
    # ds.targets=np.array(ds.targets)
    # # 如果ul_sample, ul_sample_idxs已经预先选择好
    # # 如果ul_class, ul_sample_idxs需要遍历记录类别为9的样本索引
    # ul_class_idxs=[] # 对应class的所有sample idx
    ...
    #     if ds.targets[idx]==9:
    #         class9_idxs.append(idx)


    train_ldr_X, train_ldr_Y = prepare_attack_data(target_model,train_ldr,device,top_k,test_dataset=False)
    # attack_test_acc = attack_inference(attack_model, mia_testX, mia_testY, device)
    # print('attack_train_acc:',attack_test_acc)


    
    val_ldr_X, val_ldr_Y = prepare_attack_data(target_model,val_ldr,device,top_k,test_dataset=True)
    # attack_test_acc = attack_inference(attack_model, mia_testX, mia_testY, device)
    ...
    if False:
        ...
        attackdataset = (train_ldr_X+val_ldr_X, train_ldr_Y+val_ldr_Y)
        # print(len(attackdataset[0]))
        # print(len(attackdataset[1]))
        # print(shadowX[0].shape)
    ...
    # attack_test_acc = attack_inference(attack_model, targetX, targetY, device)
    ...
    model_path='/CIS32/zgx/Unlearning/FedUnlearning/baselines/models/amnesiac_model_sub.pkl'
